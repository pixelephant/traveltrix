...
$(document).ready( function () {
	...
	$("#cta a").click(function(){
		$("#contactwrap").slideToggle(300,function(){
	...
	function closeFeature(el){
		...
		$(this).find(".open-details").html("More info");
	}
	...
	$(".feature").click(function(){	
		...
		if($(this).hasClass("open")){
			...
			$(this).find(".open-details").html("Less info");
			var $this = $(this);
	...
	$("#newsletterform").validate({
		...
		$.post("lib/php/email.php",{
				"email" : $("#newsletter-email").val()
			},function(resp){
				if(resp == "sikeres"){
					$("#newsletter-form .resp").removeClass("error").html("Thank you. We'll get in touch.");
				}
				else{
					$("#newsletter-form .resp").addClass("error").html("Oops. Something broke, please try again.");
				}
			});
	...
	$("#contactform").validate({
		...
		$.post("lib/php/register.php",{
				...
				if(resp == "sikeres"){
					$("#contactform .resp").removeClass("error").html("Thank you. We'll get in touch.");
				}
				else{
					$("#contactform .resp").addClass("error").html("Oops. Something broke, please try again.");
				}
			});
